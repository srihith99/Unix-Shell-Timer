...
The execution time for each command will also be displayed to the shell user 
( The mmap API in C language was used for communication of time between processes ) 
